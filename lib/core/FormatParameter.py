...
if __name__ == "__main__":
    data = {'username': '22', 'sex': '${instn21}|<11,12>', 'time': '${current}|<>', 'site': 'HangZhou',
            'data_group': [{'order': 1, 'data': {'flag': True}}, {'order': 2, 'data': {'flag': False}}]}
    json_string = json.dumps(data)

    sample = FormatParam()
    print(sample.format_(data))
