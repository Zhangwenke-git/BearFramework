...
logger = logger.Logger("myParamiko")


class MyParamiko:

    def __init__(self, linux_server_dict, processNm):
        self.hostip = linux_server_dict.get(processNm).get("hostname")
        self.port = linux_server_dict.get(processNm).get("port")
        self.username = linux_server_dict.get(processNm).get("username")
        self.password = linux_server_dict.get(processNm).get("password")
